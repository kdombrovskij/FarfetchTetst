...
namespace FarfetchTetst.Capabilities
{
    public class Capabilities
    {
        ...
        private static readonly string APP_PACKAGE_CAPABILITY = "com.farfetch.farfetchshop";
        private static readonly string APP_ACTIVITY_CAPABILITY = "com.farfetch.farfetchshop.activities.StartActivity";
